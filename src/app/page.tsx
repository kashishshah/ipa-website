...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <motion.div
        className="hidden md:block bg-gradient-to-r from-cyan-600 to-blue-500 text-white py-2 px-4 md:px-8"
        initial={{ y: -50 }}
        animate={{ y: 0 }}
      ...
      <header className="sticky top-0 z-30 bg-white py-3 px-4 md:px-8 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <motion.button
              className="hidden sm:flex bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-4 py-2 rounded-full font-bold shadow-md items-center"
              whileHover={{
                scale: 1.05,
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <motion.div
              id="menu-container"
              className="absolute right-0 top-0 h-full w-full sm:w-80 bg-gradient-to-b from-blue-600 to-blue-700 shadow-xl overflow-y-auto"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
            ...
            >
              <div className="p-6">
                ...
                <motion.button
                  className="sm:hidden w-full bg-white text-blue-600 px-4 py-3 rounded-full font-bold shadow-md flex items-center justify-center mb-6"
                ...
                <ul className="space-y-1">
                  {navItems.map((item, index) => (
                    ...
                    >
                      ...
                      <Link
                        href="#"
                        className="flex items-center justify-between p-3 text-white rounded-lg relative z-10"
                        onClick={() => setIsMenuOpen(false)}
                      >
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <h3 className="text-cyan-200 font-medium mb-4">Contact Us</h3>
                  <div className="space-y-3 text-white/80 text-sm">
                    <a
                      href="mailto:hq@indianplumbing.org"
                      className="flex items-center"
                    >
                      <Mail size={14} className="mr-2 text-cyan-200" />
                      hq@indianplumbing.org
                    </a>
                    <a href="tel:+91-11-49863152" className="flex items-center">
                      <Phone size={14} className="mr-2 text-cyan-200" />
